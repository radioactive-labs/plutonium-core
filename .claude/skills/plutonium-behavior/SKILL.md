...
For a bulk operation, a long-running one, or anything that needs an audit trail, `async` a persisted, resumable run instead of executing inline — see [[plutonium-async-interactions]].
