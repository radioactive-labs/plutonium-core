...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "phlexi-form", "~> 0.9.0"
  spec.add_dependency "phlexi-table", "~> 0.1.0"
  spec.add_dependency "phlexi-display", "~> 0.1.0"
  spec.add_dependency "phlexi-menu", "~> 0.3.0"
