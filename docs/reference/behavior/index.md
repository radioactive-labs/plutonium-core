...
- **[Async Interactions](./async-interactions)** — run an interaction asynchronously: `dispatches_to` a persisted, resumable run instead of executing inline, for bulk operations, long-running work, or anything that needs an audit trail.
...
| Bulk/long-running operations, audit trail | [Async Interactions](./async-interactions) |
