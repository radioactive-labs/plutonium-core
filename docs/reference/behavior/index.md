...
- **[Async Interactions](./async-interactions)** — run an interaction asynchronously: `async` a persisted, resumable run instead of executing inline, for bulk operations, long-running work, or anything that needs an audit trail.
