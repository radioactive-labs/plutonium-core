    ...
    "node_modules/cropperjs/dist/cropper.js"(exports, module) {
      (function(global2, factory) {
        ...
        function getStringFromCharCode(dataView, start2, length) {
          var str = "";
          length += start2;
          for (var i4 = start2; i4 < length; i4 += 1) {
...
this.ifd0Offset: ${this.ifd0Offset}, file.byteLength: ${e4.byteLength}`), e4.tiff && await e4.ensureChunk(this.ifd0Offset, o2(this.options));
  ...
  var VirtualList = class extends x {
    ...
    render(_ref) {
      ...
      let start2 = Math.floor(offset2 / rowHeight);
      let visibleRowCount = Math.floor(height / rowHeight);
      if (overscanCount) {
        start2 = Math.max(0, start2 - start2 % overscanCount);
        visibleRowCount += overscanCount;
      }
      const end2 = start2 + visibleRowCount + 4;
