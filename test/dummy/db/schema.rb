...
ActiveRecord::Schema[8.1].define(version: 2026_01_19_123920) do
  ...
  add_foreign_key "demo_features_product_tags", "products"
  add_foreign_key "demo_features_product_tags", "tags"
  add_foreign_key "demo_features_products", "categories"
  add_foreign_key "demo_features_reviews", "products"
  add_foreign_key "demo_features_reviews", "users"
  add_foreign_key "demo_features_variants", "products"
