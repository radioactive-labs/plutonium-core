...
class ConnGeneratorTest < Rails::Generators::TestCase
  ...
  # A gem-provided resource (e.g. Plutonium::Interaction::Run) can have a
  ...
  test "expected_parent_policy/definition recognize a base outside ::ResourcePolicy/::ResourceDefinition" do
    ...
    generator.instance_variable_set(:@resource_class, "Plutonium::Interaction::Run")

    assert_equal Plutonium::Interaction::RunPolicy, generator.send(:expected_parent_policy)
    assert_equal Plutonium::Interaction::RunDefinition, generator.send(:expected_parent_definition)
  end
