...
module Plutonium
  class SmartCacheTest < Minitest::Test
    def setup
      ...
      Plutonium::SmartCache.force_caching = nil
    ...
    def test_cache_unless_reloading_caches_when_enabled
      Plutonium::SmartCache.force_caching = true
    ...
    def test_cache_unless_reloading_does_not_cache_when_disabled
      Plutonium::SmartCache.force_caching = false
    ...
    def test_force_caching_is_thread_local
      thread1 = Thread.new do
        Plutonium::SmartCache.force_caching = true
        assert Plutonium::SmartCache.force_caching, "force_caching should be true in thread1"
      end

      thread2 = Thread.new do
        assert_nil Plutonium::SmartCache.force_caching, "force_caching should be nil in thread2"
      end

      thread3 = Thread.new do
        Plutonium::SmartCache.force_caching = false
        refute Plutonium::SmartCache.force_caching, "force_caching should be false in thread3"
      end
