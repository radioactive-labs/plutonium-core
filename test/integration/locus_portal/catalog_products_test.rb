...
class LocusPortal::CatalogProductsTest < ActionDispatch::IntegrationTest
  ...
  resource_tests_for Catalog::Product, portal: :locus
  ...
  test "lists variants for a product (has_many)" do
    ...
    get "/locus/catalog/products/#{product.id}/nested_variants"
  ...
  test "lists reviews for a product (has_many)" do
    ...
    get "/locus/catalog/products/#{product.id}/nested_reviews"
    assert_response :success
  end
  ...
  test "shows product detail (has_one)" do
    ...
    get "/locus/catalog/products/#{product.id}/nested_product_detail"
    assert_response :success
  end
  ...
  test "lists comments on a product (polymorphic)" do
    ...
    get "/locus/catalog/products/#{product.id}/nested_comments"
    assert_response :success
  end
  ...
  test "shows a category (self-referential)" do
    ...
    get "/locus/catalog/categories/#{parent.id}"
    assert_response :success
  end
