...
module Plutonium
  module Interaction
    ...
    #
    # Named +RunDefinition+ rather than +Runs::Definition+ because definition
    ...
    # +MyPortal::Plutonium::Interaction::RunDefinition+.
    class RunDefinition < Plutonium::Resource::Definition
      ...
      # See Plutonium::Interaction::Run#outcome.
      ...
      class Display < Display
        ...
        def render_before_fields
          render Plutonium::UI::Interaction::RunProgress.new(resource_record!)
        end
      end
      ...
      class ShowPage < ShowPage
        ...
        def progress_poll?
          current_turbo_frame == Plutonium::UI::Interaction::RunProgress.frame_id(resource_record!)
        end
      end
    end
  end
