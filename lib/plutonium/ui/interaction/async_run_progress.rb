...
module Plutonium
  module UI
    module Interaction
      ...
      # poll). {AsyncRunDefinition::ShowPage} short-circuits the page for exactly this
      # request; this class drops its own frame tag to match.
      class AsyncRunProgress < Plutonium::UI::Component::Base
        ...
        # NOT success: see Plutonium::Interaction::AsyncRun#outcome.
        BADGE_VARIANTS = {
          "pending" => "warning",
          "running" => "info",
          "completed" => "success",
        ...
        # alone it reads as work done. See AsyncRuns::Executor#refuse_partial_batch.
        def render_progress
