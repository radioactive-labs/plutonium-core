...
module Plutonium
  module UI
    module Interaction
      ...
      # poll). {RunDefinition::ShowPage} short-circuits the page for exactly this
      ...
      class RunProgress < Plutonium::UI::Component::Base
        ...
        # NOT success: see Plutonium::Interaction::Run#outcome.
        BADGE_VARIANTS = {
          "pending" => "warning",
          "running" => "info",
          "completed" => "success",
        ...
        # alone it reads as work done. See Runs::Executor#refuse_partial_batch.
        def render_progress
        ...
        # A nil target_id is the RUN-LEVEL sentinel (see Run#record_target_failure!),
