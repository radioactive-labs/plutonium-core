      ...
      class Action
        ...
        class << self
          def create_action(button: nil)
            button ||= Plutonium::UI::Button.create_button

            new :create, button:, route: {action: :new}
          end

          def show_action(button: nil)
            button ||= Plutonium::UI::Button.show_button

            new :show, button:
          end

          def edit_action(button: nil)
            button ||= Plutonium::UI::Button.edit_button

            new :edit, button:, route: {action: :edit}
          end

          def destroy_action(button: nil)
            button ||= Plutonium::UI::Button.destroy_button
